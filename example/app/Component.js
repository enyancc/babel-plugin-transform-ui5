...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = doPing;
...
var $;
sap.ui.define('app/store/api', ['jquery.sap.global'], function (_$) {
  $ = _$
});
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["b"] = getState;
/* harmony export (immutable) */ __webpack_exports__["c"] = setModel;
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return dispatch; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__actions__ = __webpack_require__(331);
...
function setModel(controller) {
  controller.getView().setModel(getState());
}

var dispatch = function () {
  var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(actionName) {
    var _len,
        payload,
        _key,
        _args = arguments;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            if (__WEBPACK_IMPORTED_MODULE_0__actions__[actionName]) {
              _context.next = 2;
              break;
            }

            return _context.abrupt('return', console.error('"' + actionName + '" is not registered!'));

          case 2:
            _context.prev = 2;

            for (_len = _args.length, payload = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
              payload[_key - 1] = _args[_key];
            }

            return _context.abrupt('return', __WEBPACK_IMPORTED_MODULE_0__actions__[actionName].apply(__WEBPACK_IMPORTED_MODULE_0__actions__, [{ state: state, dispatch: dispatch }].concat(payload)));

          case 7:
            _context.prev = 7;
            _context.t0 = _context['catch'](2);

            console.error('Error during dispatch of \'' + actionName + '\'', _context.t0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__example_actions__ = __webpack_require__(332);
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "exampleButtonClick", function() { return __WEBPACK_IMPORTED_MODULE_0__example_actions__["a"]; });
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return exampleButtonClick; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__api__ = __webpack_require__(124);
function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; }

var MessageToast;
sap.ui.define('app/store/actions/example-actions', ['sap/m/MessageToast'], function (_MessageToast) {
...
var exampleButtonClick = function () {
  var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee(_ref, listId) {
  ...
  return function exampleButtonClick(_x, _x2) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__controller_App__ = __webpack_require__(335);
var UIComponent;
var AppController;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__store__ = __webpack_require__(330);
var Controller;
sap.ui.define('app/controller/App', ['sap/ui/core/mvc/Controller'], function (_Controller) {
  ...
  return Controller.extend('app.controller.AppController', {
    onInit: function () {
      Object(__WEBPACK_IMPORTED_MODULE_0__store__["c" /* setModel */])(this);
    },
    onHelloWorldClick: function () {
      Object(__WEBPACK_IMPORTED_MODULE_0__store__["a" /* dispatch */])('exampleButtonClick');
    }
  });
});
